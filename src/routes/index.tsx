    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <nav className="relative z-10 flex items-center justify-between px-8 py-6 border-b border-gray-800">
        ...
        <div className="flex gap-4">
          ...
          <Link to="/login">
            <button className="px-5 py-2 border border-gray-700 rounded hover:bg-gray-900">
              Login
            </button>
          </Link>

          <Link to="/dashboard">
            <button className="px-5 py-2 bg-green-600 rounded hover:bg-green-500">
              Open Dashboard
            </button>
          </Link>
      ...
      <section className="relative z-10 flex flex-col items-center justify-center text-center px-6 py-32">
        ...
        <div className="flex gap-5 mt-10">
          ...
          <Link to="/login">
            <button className="bg-green-600 hover:bg-green-500 px-8 py-4 rounded-xl text-lg font-semibold shadow-lg shadow-green-500/20">
              Start Coding Free
            </button>
          </Link>

          <Link to="/dashboard">
            <button className="border border-gray-700 hover:bg-gray-900 px-8 py-4 rounded-xl text-lg">
              Open Workspace
            </button>
          </Link>
